...
class SampleAPI {
        ...
        if ( $this->SimpleAPI->getRequestContentType() === RequestContentType::JSON ) {
            ...
            switch( $this->APICore->getRequestMethod() ) {
                case RequestMethod::POST:
                    $this->APISettings = new APIParams( $_POST );
                    break;
                case RequestMethod::GET:
                    $this->APISettings = new APIParams( $_GET );
                    break;
    ...
    */
    ...
    private function generateResponse() {
        ...
        //$Response->Member1               = $this->calculateResponseMember1();
        //$Response->Member2               = $this->calculateResponseMember2();
