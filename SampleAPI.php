...
class SampleAPI {
    ...
    //define the following parameters if you intend to allow XML output
    ...
    private function generateResponse() : string {
        ...
        switch ( $this->APIParams->ResponseType ) {
            ...
            case ResponseType::XML:
                ...
                $response = XmlTransform::ObjectToXml( $ResponseObj, $this->XMLParentElement, $this->XMLNamespace );
                break;
